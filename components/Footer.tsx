        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-sm">
              Free AI Tool Spend Audit for Startups. Find overspending in under 2 minutes.
            </p>
            <p className="text-gray-500 text-xs">
              Built by <a href="https://credex.rocks" target="_blank" rel="noopener noreferrer" className="text-emerald-400 hover:text-emerald-300">Credex</a>
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm">
              © {new Date().getFullYear()} SpendLens by Credex. All rights reserved.
            </p>
